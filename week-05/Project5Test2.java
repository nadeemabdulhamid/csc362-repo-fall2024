   ...
   static class A implements Runnable { 
      public void run() {
         ...
         try {
            ...
            System.out.println("Tx A: request xlock block 1");
            txA.setInt(blk1, 0, 0, false);
            System.out.println("Tx A: receive xlock block 1");


            /// ******* A should be willing to wait for this xlock
